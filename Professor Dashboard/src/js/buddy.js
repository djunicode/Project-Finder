...
document.addEventListener('DOMContentLoaded', function () {
  ...
  /*tab-wrappers*/
  if (document.getElementById('tabsWrappers')) {
    var tabsTriggers = document.querySelectorAll('.tabs-wrappers [role="tab"]'),
        tabsPanels = document.querySelectorAll('.tabs-wrappers [role="tabpanel"]'),
        tabsWrappers = document.getElementById('tabsWrappers');

    if (window.innerWidth > 640) {
      // set height to tabsWrapper depending of panel height + 100px
      tabsWrappers.style.height = document.querySelector('[aria-selected="true"]').nextElementSibling.clientHeight + 100 + 'px';
    }

    window.addEventListener('resize', function () {
      if (this.innerWidth > 640) tabsWrappers.style.height = document.querySelector('[aria-selected="true"]').nextElementSibling.clientHeight + 100 + 'px';else tabsWrappers.style.height = 'auto';
    });
    ...
    var toggleTabsContent = function toggleTabsContent(event) {
      ...
      if (window.innerWidth > 640) {
        // set height to tabsWrapper depending of panel height + 100px
        tabsWrappers.style.height = document.getElementById(ariaControls).clientHeight + 100 + 'px';
      }

      window.addEventListener('resize', function () {
        if (this.innerWidth > 640) tabsWrappers.style.height = document.getElementById(ariaControls).clientHeight + 100 + 'px';else tabsWrappers.style.height = 'auto';
      });
    };
